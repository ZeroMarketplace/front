...
<template>
  <div class="d-flex flex-column align-sm-end align-center justify-space-between px-4 pt-6 stepper-wrapper flex-sm-row">
    ...
    <div class="d-flex flex-column align-center text-center ga-1 mx-3 stepWidth">
    ...
    <div class="d-flex ga-2 text-center align-center">
        <v-avatar v-if="stepActive >= 2" size="18" class="bg-white mdi mdi-check">
    ...
    <div class="d-flex flex-column align-center text-center ga-1 mx-3 stepWidth">
        ...
        <div class="d-flex ga-2 align-center">
          <v-avatar v-if="stepActive >= 3" size="18" class="bg-white">
    ...
    <div class="d-flex flex-column align-center text-center ga-1 mx-3 stepWidth">
        ...
        <div class="d-flex ga-2 align-center">
          <v-avatar v-if="stepActive >= 4" size="18" class="bg-white">
