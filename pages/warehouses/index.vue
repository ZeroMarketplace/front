        ...
        <template v-slot:default>
          <thead>
            <tr>
              ...
              <th class="text-14 text-no-wrap">فروش آنلاین</th>
              <th class="text-14 text-no-wrap">خرده فروشی</th>
          ...
          <tbody>
            <tr v-for="item in filteredList" :key="item._id">
              ...
              <td>
                <v-chip
                  rounded="pill"
                  :color="item.onlineSales ? 'info' : 'grey'"
                  variant="flat"
                  size="small"
                  label
                >
              ...
              <td>
                <v-chip
                  rounded="pill"
                  :color="item.retail ? 'warning' : 'grey'"
                  variant="flat"
                  size="small"
                  label
                >
              ...
              <td>
                <div class="d-flex ga-3 align-center justify-center">
                  <RouterLink :to="`/warehouses/edit/${item._id}`">
                    ...
                    <v-tooltip activator="parent" location="bottom">ویرایش انبار</v-tooltip>
                  </RouterLink>
                  ...
                  <RouterLink to="" @click.stop="handleDeleteWarehouse(item._id)" class="cursor-pointer">
                    <v-avatar color="lighterror" size="32">
                      <Icon icon="solar:trash-bin-minimalistic-linear" class="text-error" height="18" />
                    </v-avatar>
                    <v-tooltip activator="parent" location="bottom">حذف انبار</v-tooltip>
                  </RouterLink>
                </div>
              </td>
            </tr>
