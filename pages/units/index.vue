              ...
              <td>
                <div class="d-flex ga-3 align-center justify-center">
                  <RouterLink :to="`/units/edit/${item._id}`">
                    ...
                    <v-tooltip activator="parent" location="bottom">ویرایش واحد</v-tooltip>
                  </RouterLink>
                  ...
                  <RouterLink to="" @click.stop="handleDeleteUnit(item._id)" class="cursor-pointer">
                    <v-avatar color="lighterror" size="32">
                      <Icon icon="solar:trash-bin-minimalistic-linear" class="text-error" height="18" />
                    </v-avatar>
                    <v-tooltip activator="parent" location="bottom">حذف واحد</v-tooltip>
                  </RouterLink>
                </div>
              </td>
            </tr>
